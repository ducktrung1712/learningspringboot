...
public enum ErrorCode {
    ...
    USERNAME_INVALID(1002, "Username must be at leats 3 characters", HttpStatus.BAD_REQUEST),
    INVALID_PASSWORD(1003, "Password must be at leats 3 characters", HttpStatus.BAD_REQUEST),
